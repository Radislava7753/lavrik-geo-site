      ...
      <div className="max-w-4xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Écrivez-moi. Communication 100% écrite.
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-xl p-8 md:p-12">
          <div className="space-y-6">
            <div>
              ...
              <p className="text-lg text-gray-600">AI Visibility &amp; GEO Strategy</p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:ai-analytics@n8nmaster1.site" className="text-primary-600 hover:underline">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="https://wa.me/14383945812" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:underline">
                    +1 438 394 5812
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="https://www.linkedin.com/in/lavrikgeo" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">70 Pl. des Écorceurs, Chicoutimi, Québec, Canada</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 p-4 bg-primary-50 rounded-lg border border-primary-100">
              <p className="text-center text-gray-700">
                <span className="font-semibold">Réponse sous 24 heures.</span>
              </p>
            </div>
